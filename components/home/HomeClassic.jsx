          ...
          {isWorking ? (
            ...
            <>
              ...
              <View style={s.sectionHead}>
                ...
                {postedGigs.length > 0 ? (
                  <Pressable onPress={() => router.push("/(tabs)/profile/my-gigs")} style={s.managePill}>
                    <Ionicons name="grid-outline" size={13} color={HIRE.accent} />
                    <Text style={s.managePillTxt}>Manage all</Text>
                    <View style={[s.managePillCount, { backgroundColor: HIRE.badgeBg }]}><Text style={[s.managePillCountTxt, { color: HIRE.badgeTx }]}>{postedGigs.length}</Text></View>
                    <Ionicons name="chevron-forward" size={13} color={HIRE.accent} />
                  </Pressable>
                ) : null}
              </View>
              {!myGigs ? (
...
const makeStyles = (C) => StyleSheet.create({
  ...
  managePill: { flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: C.surface, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingLeft: 11, paddingRight: 8, paddingVertical: 6 },
  managePillTxt: { fontFamily: FJ.sbold, fontSize: 12.5, color: HIRE.accent },
  managePillCount: { minWidth: 18, height: 18, borderRadius: 9, alignItems: "center", justifyContent: "center", paddingHorizontal: 5 },
  managePillCountTxt: { fontFamily: FJ.bold, fontSize: 11 },
