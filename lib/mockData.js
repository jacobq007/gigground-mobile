...
export const APPLICANT_POOL = [
  { name: "Suresh Babu", verifiedTier: 3, reliability: 98, strikes: 0, distKm: 0.8, catGigs: 21, catRating: 4.9, note: "Done 20+ similar gigs in this area" },
  { name: "Kiran Raj", verifiedTier: 2, reliability: 93, strikes: 0, distKm: 1.6, catGigs: 12, catRating: 4.7, note: "I have a bike, can reach in 10 min" },
  { name: "Meena Kumari", verifiedTier: 2, reliability: 96, strikes: 0, distKm: 2.4, catGigs: 8, catRating: 4.8, note: "" },
  { name: "Arjun Nair", verifiedTier: 1, reliability: 88, strikes: 1, distKm: 1.1, catGigs: 15, catRating: 4.5, note: "Available all day today" },
  { name: "Divya Rajan", verifiedTier: 1, reliability: 91, strikes: 0, distKm: 3.8, catGigs: 4, catRating: 4.6, note: "" },
  { name: "Vignesh M", verifiedTier: 0, reliability: 78, strikes: 2, distKm: 0.6, catGigs: 2, catRating: 4.1, note: "New here but very hardworking" },
];
