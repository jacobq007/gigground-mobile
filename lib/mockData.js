...
export const APPLICANT_POOL = [
  { name: "Priya Nair", verifiedTier: 2, reliability: 97, strikes: 0, distKm: 1.2, catGigs: 31, catRating: 4.9, skilledIn: ["maths"], openTo: [], note: "M.Sc Maths, 6 yrs. CBSE & State board." },
  { name: "Suresh Babu", verifiedTier: 3, reliability: 98, strikes: 0, distKm: 0.8, catGigs: 21, catRating: 4.9, skilledIn: [], openTo: ["delivery", "moving", "cleaning"], note: "Done 20+ similar gigs in this area" },
  { name: "Ravi Menon", verifiedTier: 2, reliability: 94, strikes: 0, distKm: 3.4, catGigs: 18, catRating: 4.8, skilledIn: ["science", "maths"], openTo: [], note: "B.Ed Physics, JEE/NEET foundation" },
  { name: "Kiran Raj", verifiedTier: 2, reliability: 93, strikes: 0, distKm: 1.6, catGigs: 12, catRating: 4.7, skilledIn: [], openTo: ["delivery", "moving"], note: "I have a bike, can reach in 10 min" },
  { name: "Meena Kumari", verifiedTier: 2, reliability: 96, strikes: 0, distKm: 2.4, catGigs: 8, catRating: 4.8, skilledIn: ["english"], openTo: ["cleaning"], note: "" },
  { name: "Arjun Nair", verifiedTier: 1, reliability: 88, strikes: 1, distKm: 1.1, catGigs: 15, catRating: 4.5, skilledIn: [], openTo: ["delivery", "errands"], note: "Available all day today" },
  { name: "Divya Rajan", verifiedTier: 1, reliability: 91, strikes: 0, distKm: 3.8, catGigs: 4, catRating: 4.6, skilledIn: [], openTo: ["cleaning", "event"], note: "" },
  { name: "Karthik S", verifiedTier: 0, reliability: 80, strikes: 0, distKm: 0.9, catGigs: 1, catRating: 0, openToLearn: true, openTo: ["errands"], note: "New here, keen to learn tutoring" },
  { name: "Vignesh M", verifiedTier: 0, reliability: 78, strikes: 2, distKm: 0.6, catGigs: 2, catRating: 4.1, openTo: ["errands", "delivery"], note: "New here but very hardworking" },
];
