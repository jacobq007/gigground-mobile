...
// Soft tint + icon colour per category. Single source of truth — the Skills
// grid and the Post-a-gig category grid both read from here, so editing a
// category's colour (or adding one below) updates every screen at once.
export const GROUP_TINT = {
  tutoring: "#EEF0FE", cooking: "#FDEFE7", beauty: "#FBE9F4",
  repairs: "#E9F3EE", media: "#EAF0FB", general: "#F1F0EE",
};
export const GROUP_TINT_FG = {
